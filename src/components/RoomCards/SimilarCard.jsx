...
import { FaWifi, FaBed, FaShower, FaSwimmingPool, FaSpa } from "react-icons/fa";
...
const SimilarCard = ({ property }) => {
  ...
  return (
    <div className="w-84 min-w-64 max-w-84 border border-gray-300 rounded-2xl">
      <Image
        src={property.image}
        alt={property.name}
      ...
      />
      <div className="p-2">
        <h2 className="font-bold text-lg mt-2 break-words">{property.name}</h2>
        <p className="text-gray-600">{property.location}</p>

        <div className="w-full mt-2 bg-gray-300 rounded-2xl p-1">
          <p className="text-sm mx-2 text-gray-700 break-words whitespace-normal">
