...
const RoomCard = ({
  ...
  return (
    <div 
      className="ml-3 sm:ml-auto mb-5 h-auto sm:w-84 min-h-[700px] flex flex-col border border-gray-300 rounded-2xl shadow-md hover:shadow-lg transition cursor-pointer"
